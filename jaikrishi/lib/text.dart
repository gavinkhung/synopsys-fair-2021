Map texts = {
  "DiseaseDetection": {
    ...
    "2": "Instructions",
    "3":
        "Please take a close-up photo of the diseased part of the plant from you mobile phone or gallery",
  ...
  "FirstPage": {
    ...
    "9":
        "Join JaiKrishi now at this link: https://play.google.com/store/apps/details?id=com.jaikrishi.appjaikrishi",
    "10": "Crop Profile",
    "11": "Short",
    "12": "Medium",
    "13": "Long",
  ...
  "DetectRice": {"1": "Detect", "2": "Detected: ", "3": "Disease Treatment"},
  "DetectRandomPicture": {"1": "Detect", "2": "Please send an image of Rice!"},
  "CropStatus": {
    "1": "Crop Status",
    "2": "Disease Predictions",
    "3":
        "Based on the days from seeding, we highly recommend that you do the following steps to make sure that your crop is healthy",
    ...
    "6":
        "For 5 cents of Nursery size, apply 1 kg each of Nitrozen, Phosphorous, Potash fertilizer during ploughing",
    "7": "See More",
  ...
  "SeedingLocation": {
    "1": "Seeding & Location",
    "2":
        "Seeding and transplantation dates of your crop would give you timely crop disease alerts.",
  ...
  "VarietyLocation": {
    "1": "Variety & Location",
    "2":
        "Enter your crop variety and  the location of your crop to get disease alerts.",
  ...
  "Instructions": {"1": "Video Instructions", "2": "Learn More", "3": "Step"},
  "History": {
    "based": "Since it has been ",
    "days": " days from sowing, ",
    "recomend":
        "we highly recommend that you do the following steps to make sure that your crop is healthy",
    "glad": "Great to hear!",
    ...
    "present":
        " is present in your crop. Please check your crop as soon as possible. ",
    ...
    "ok": "Okay",
    "warningNotif":
        " warns that you need to do the following steps to keep your crop healthy: ",
    "warningDisease":
        " might be present in your crop. Please use our detection feature to check.",
    "warns": " warns that ",
    "suggestLink":
        "We highly recommend that you watch the following video. To view the video in app please click \"See More\"",
    "suggestLinkOnPrev":
        "We highly recommend that you watch the following video"
  },
  "prevNotifications": {
